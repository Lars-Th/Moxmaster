...
export function useToast(): UseToastReturn {
  ...
  const success = (title: string, message?: string, options: Partial<ToastOptions> = {}): number => {
    return showToast({
      type: 'success',
      title,
      message,
  ...
  const error = (title: string, message?: string, options: Partial<ToastOptions> = {}): number => {
    return showToast({
      type: 'error',
      title,
      message,
  ...
  const warning = (title: string, message?: string, options: Partial<ToastOptions> = {}): number => {
    return showToast({
      type: 'warning',
      title,
      message,
  ...
  const info = (title: string, message?: string, options: Partial<ToastOptions> = {}): number => {
    return showToast({
      type: 'info',
      title,
      message,
