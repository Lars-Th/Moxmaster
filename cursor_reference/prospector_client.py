...
class ProspectorClient():
    def __init__(self, env):
        ...
        if len(db_settings) > 0:
            self.client_id = "cid_1a883e3bac7f4b9198633c724a211033"
            self.client_secret = "cs_1HJWP03nk/elflvU45bOKT4gWhuORsYBbboXTi9oqYYiHL/Zj6SENP401sxK0Veyfpv7GPW4ysofSGzLGvOVNA=="
